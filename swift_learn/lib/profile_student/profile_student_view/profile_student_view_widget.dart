...
import 'profile_student_view_model.dart';
export 'profile_student_view_model.dart';

class ProfileStudentViewWidget extends StatefulWidget {
  const ProfileStudentViewWidget({super.key});

  @override
  State<ProfileStudentViewWidget> createState() =>
      _ProfileStudentViewWidgetState();
}

class _ProfileStudentViewWidgetState extends State<ProfileStudentViewWidget>
    with TickerProviderStateMixin {
  late ProfileStudentViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileStudentViewModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.goNamed('HomePageStudent');
            },
          ),
          title: Text(
            'Profile',
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('ProfileStudentEdit');
                                    },
                                    text: 'Edit',
