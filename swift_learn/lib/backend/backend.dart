...
import 'schema/unit_number_record.dart';
...
export 'schema/unit_number_record.dart';
...
/// Functions to query UnitNumberRecords (as a Stream and as a Future).
Future<int> queryUnitNumberRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UnitNumberRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UnitNumberRecord>> queryUnitNumberRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UnitNumberRecord.collection,
      UnitNumberRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UnitNumberRecord>> queryUnitNumberRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
