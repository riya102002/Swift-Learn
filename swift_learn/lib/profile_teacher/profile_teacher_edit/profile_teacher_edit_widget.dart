...
import 'profile_teacher_edit_model.dart';
export 'profile_teacher_edit_model.dart';

class ProfileTeacherEditWidget extends StatefulWidget {
  const ProfileTeacherEditWidget({super.key});

  @override
  State<ProfileTeacherEditWidget> createState() =>
      _ProfileTeacherEditWidgetState();
}

class _ProfileTeacherEditWidgetState extends State<ProfileTeacherEditWidget>
    with TickerProviderStateMixin {
  late ProfileTeacherEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileTeacherEditModel());
                                  ...
                                  builder: (context) => InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      await currentUserReference!
                                        ...
                                        timetable: _model.uploadedFileUrl,
                                      ));
                                    },
                                    child: ClipRRect(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await currentUserReference!
                                          ...
                                          uidType:
                                              _model.uidTextController.text,
                                        ));

                                        context.goNamed('ProfileTeacherView');
                                      },
                                      text: 'Save',
